...
export default function HeroGeometric({
  badge = 'Plug AI into Your App — in Minutes',
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-background dark:bg-black">
      <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-transparent to-blue-500/20 blur-3xl dark:from-primary/30 dark:to-blue-500/30" />
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            <img src="/tokari-logo.png" alt="logo" className="h-6 w-6" />
          ...
          >
            <h1 className="mx-4 mb-6 text-4xl font-bold tracking-tight sm:text-6xl md:mb-8 md:text-8xl">
              ...
              <span
                className={cn(
                  'bg-gradient-to-r from-primary via-primary/90 to-blue-500 bg-clip-text p-4 text-transparent',
                  // pacifico.className,
                  'font-bold',
                )}
              >
          ...
          >
            <p className="mx-auto mb-10 max-w-xl px-4 text-base leading-relaxed text-muted-foreground sm:text-lg md:text-xl">
              Tokari Core is the fast, affordable, and developer-first AI engine that powers smart features in your apps — without the headaches of tokens, rate limits, or overpriced APIs.
            </p>
          </motion.div>
